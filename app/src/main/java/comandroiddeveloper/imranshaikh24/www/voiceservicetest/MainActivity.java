package comandroiddeveloper.imranshaikh24.www.voiceservicetest;
...
public class MainActivity extends Activity {
    ...
    private static final String[] VALID_COMMANDS = {
            "darvis Best Website for Android",
            "darvis what day is it",
            "darvis who are you",
            "darvis exit"
    };
    ...
    private String getResponse(int command){
        ...
        switch (command) {
            case 0:
                ...
                responseText.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View arg0) {
                        ...
                        Intent i = new Intent(android.content.Intent.ACTION_VIEW, Uri.parse("www.androidstudio.com"));
                        startActivity(i);
                    }
                });
                break;
            case 1:
                ...
                break;
            case 2:
                retString = "Answering Machine Imran please wait...";
                break;
    ...
    private void processCommand(ArrayList<String> matchStrings){
        String response = "I'm sorry, Imran. I'm afraid I can't do that.";
